...
contract VotingContract is Ownable {
    ...
    function startVoting() public {
        require(
            _checkIfUserIsAllowed(msg.sender),
            "Sender doesn't have 0.05% of total supply"
        );
    ...
    function vote(uint256 price) public {
        ...
        if (
            ...
            _token.balanceOf(_userWithTheStrongestVoice)
        ) {
    ...
    function collectFees() public onlyOwner {
        require(
            block.timestamp - _lastTimeFeeCollected > _feeCollectTime,
            "Fee was collected this week"
        );
        require(_fees > 0);
